...
import { createCouncil } from '../service/api/CouncilService';
...
const CreateCouncilPage = () => {
  ...
  const {register, handleSubmit, formState: {errors}} = useForm<TCouncilSchema>({resolver: zodResolver(councilSchema)});
